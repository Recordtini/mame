...
void wxstar4k_state::led_w(offs_t offset, uint16_t data, uint16_t mem_mask) { if (ACCESSING_BITS_0_7) { LOGCPU("LED: %02x\n", data & 0xff); for(int i=0; i<8; i++) m_diag_led[i] = BIT(data, i); } }
